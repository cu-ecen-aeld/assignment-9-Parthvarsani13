...
# Script to run QEMU for Buildroot using the qemu_aarch64_virt_defconfig
# Host forwarding:
#   Host Port 10022 -> QEMU Port 22 (SSH)
#   Host Port 9000  -> QEMU Port 9000 (for your application)
